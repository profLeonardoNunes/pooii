 ...
 * @author Leonardo
 */
public class frmProdutoEditar extends javax.swing.JFrame {
    ...
    public frmProdutoEditar(int id) {
        initComponents();
        produto = pc.Consultar(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmProdutoEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmProdutoEditar().setVisible(true);
            }
        });
    }
